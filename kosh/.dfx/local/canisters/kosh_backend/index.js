...
import { idlFactory } from './kosh_backend.did.js';
export { idlFactory } from './kosh_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_KOSH_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./kosh_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the kosh_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./kosh_backend.did.js")._SERVICE>}
 */
export const kosh_backend = createActor(canisterId);
