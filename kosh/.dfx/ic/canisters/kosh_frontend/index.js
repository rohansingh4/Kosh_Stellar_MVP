...
import { idlFactory } from './kosh_frontend.did.js';
export { idlFactory } from './kosh_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_KOSH_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./kosh_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the kosh_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./kosh_frontend.did.js")._SERVICE>}
 */
export const kosh_frontend = createActor(canisterId);
