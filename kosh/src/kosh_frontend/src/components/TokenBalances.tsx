...
const TokenBalances = ({ actor, selectedNetwork, onAddTrustline, stellarAddress }: TokenBalancesProps) => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'Unauthorized': return 'bg-destructive/20 text-destructive border-destructive/30';
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-crypto-teal to-crypto-blue flex items-center justify-center">
              <Coins className="w-5 h-5 text-white" />
            </div>
            <div>
              <h3 className="text-lg font-semibold bg-gradient-to-r from-primary to-crypto-teal bg-clip-text text-transparent">
                Token Balances
              </h3>
