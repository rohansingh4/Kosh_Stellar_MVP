...
// get_account_balance moved to frontend - direct Stellar API call

// get_swap_quote moved to frontend - direct Stellar API call
...
// get_account_assets moved to frontend - direct Stellar API call
